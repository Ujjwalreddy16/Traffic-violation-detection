...
class Window(Frame):
    ...
    def open_file(self):
        ...
        ret, image = cap.read()
        cv2.imwrite('C:/Users/cahar/Downloads/Traffic-Violation-Detection-main/Traffic-Violation-Detection-main/Images/preview.jpg', image)

        self.show_image('C:/Users/cahar/Downloads/Traffic-Violation-Detection-main/Traffic-Violation-Detection-main/Images/preview.jpg')
    ...
    def imgClick(self, event):
        ...
        if self.counter == 2:
            ...
            print(self.line)
            print(self.rect)
            img = cv2.imread('C:/Users/cahar/Downloads/Traffic-Violation-Detection-main/Traffic-Violation-Detection-main/Images/preview.jpg')
            cv2.line(img, self.line[0], self.line[1], (0, 255, 0), 3)
            cv2.imwrite('C:/Users/cahar/Downloads/Traffic-Violation-Detection-main/Traffic-Violation-Detection-main/Images/copy.jpg', img)
            self.show_image('C:/Users/cahar/Downloads/Traffic-Violation-Detection-main/Traffic-Violation-Detection-main/Images/copy.jpg')
    ...
    def main_process(self):
        ...
        fps = reader.get_meta_data()['fps']    
        writer = imageio.get_writer('C:/Users/cahar/Downloads/Traffic-Violation-Detection-main/Traffic-Violation-Detection-main/Materials/output/output.mp4', fps=fps)
